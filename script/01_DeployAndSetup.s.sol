...
import {PaymasterDelegateOrCastVote} from "../src/PaymasterDelegateOrCastVote.sol";
...
contract DeployAndSetupScript is Script {
    function run() external {
        ...
        PaymasterDelegateOrCastVote paymaster =
            new PaymasterDelegateOrCastVote(entryPoint, erc20TokenAddress, governorBravoAddress);
